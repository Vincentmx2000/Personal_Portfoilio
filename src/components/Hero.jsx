...
const Hero = () => {
    ...
    const socials = [
        ...
        {
            icon: <Mail size={20} />,
            url: 'mailto:jeniferamose@gmail.com',
            label: 'Email'
        }
    ];
    ...
    return (
        <section id="home" className="hero">
            <div className="hero-content">
                <p className="hero-tagline">Welcome to my space</p>
                <h1 className="hero-name">Vincent</h1>
                <h2 className="hero-title">
                    Full Stack Developer
                </h2>
                <p className="hero-description">
                    I turn ideas into fast, scalable web applications — blending clean design with reliable, maintainable code.
                </p>
